...
> * Migrating Pip packages over requires fully built versions of Python that matches the deployment versions.
...
>
> ---
> Future editions will streamline multi-version installation and package management procedures, which will come **Soon<sup>TM</sup>**## Python Minimal DE (Development Environment) for Linux
This project is mainly designed to make a completely offline capable development of Python. Developed for deployment in **Debian** systems. 
<br>
