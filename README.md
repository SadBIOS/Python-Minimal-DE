...
><br>
>
> Future editions will streamline multi-version installation and package management procedures. It will come **Soon<sup>TM</sup>**## Python Minimal DE (Development Environment) for Linux
This project is mainly designed to make a completely offline capable development of Python. Developed for deployment in **Debian** systems. 
<br>
