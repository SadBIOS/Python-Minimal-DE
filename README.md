...
Yes, I know that [UV](https://docs.astral.sh/uv/) is way faster and also has capabilities as offline operation but I trust my own tools and making things is often a great way of learning. Even if they are not that useful.
